...
class TestSolverIntegrationBasic:
    ...
    def test_full_solve_workflow(self):
        ...
        assert all(table.flop and table.turn and table.river for table in possible_rivers)
...
class TestSolverIntegrationKnownScenarios:
    ...
    def test_scenario_pair_vs_pair_vs_high_card(self):
        ...
        for river_table in possible_rivers[:1]:  # Check first solution
            ...
            assert (p2_flop.rank, p2_flop.tie_breakers) > (p1_flop.rank, p1_flop.tie_breakers)
            assert (p1_flop.rank, p1_flop.tie_breakers) > (p3_flop.rank, p3_flop.tie_breakers)
